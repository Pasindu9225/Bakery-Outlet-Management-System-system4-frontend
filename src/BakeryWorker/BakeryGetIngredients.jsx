    ...
    <div className="fixed inset-0 bg-backdrop bg-opacity-50 z-[9999999] flex items-center justify-center p-4">
      <div className="bg-elevated rounded-xl shadow-2xl w-full max-w-md">
        <div className="p-5 border-b border-line flex items-center justify-between">
          ...
          <button aria-label="Close" onClick={onClose} className="p-1.5 hover:bg-app rounded-lg">
        ...
        <div className="p-5 border-t border-line flex gap-3 justify-end">
          <button
            onClick={onClose}
            disabled={loading}
            className="px-4 py-2 border border-line text-fg-secondary text-[13px] font-[500] rounded-lg hover:bg-subtle"
          >
            Cancel
          </button>
          <button
            onClick={onConfirm}
            disabled={loading}
            className="px-4 py-2 bg-success-solid text-on-brand text-[13px] font-[500] rounded-lg hover:bg-success-solid flex items-center gap-2 disabled:opacity-60"
          >
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8 overflow-y-auto">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6">
            <div>
              <h1 className="text-[20px] font-[600] text-fg mb-1">Get Ingredients</h1>
          ...
          {showNewForm && (
            <div className="bg-surface rounded-lg shadow-sm border border-line p-6 mb-5">
              <div className="flex items-center gap-2 mb-4">
                <ClipboardList size={16} className="text-brand-fg" />
                <h3 className="text-[15px] font-[600] text-fg">New Ingredient Request</h3>
              </div>
              <NewRequestForm
          ...
          <div className="bg-surface rounded-lg shadow-sm border border-line p-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-5 gap-3">
              <h3 className="text-[16px] font-[600] text-fg">My Ingredient Requests</h3>
            ...
            {loading ? (
              <div className="text-center py-14">
                <RefreshCw size={36} className="mx-auto text-brand-fg mb-4 animate-spin" />
                <p className="text-[14px] font-[500] text-fg">Loading requests...</p>
              </div>
            ) : filteredRequests.length === 0 ? (
              <div className="text-center py-14">
                <ShoppingBasket size={44} className="mx-auto text-fg-muted mb-4" />
                <p className="text-[15px] font-[500] text-fg mb-1">No ingredient requests yet</p>
                          ...
                          <table className="w-full text-[12px]">
                            <thead>
                              <tr className="border-b border-line">
                                <th className="text-left py-2 px-2 font-[500] text-fg-secondary">Ingredient</th>
                                <th className="text-center py-2 px-2 font-[500] text-fg-secondary">Requested</th>
                                <th className="text-center py-2 px-2 font-[500] text-fg-secondary">Issued</th>
                                <th className="text-center py-2 px-2 font-[500] text-fg-secondary">Unit</th>
                              </tr>
                            </thead>
                            <tbody>
                              {request.items.map((item) => (
